  ...
  getQuestions(): Observable<any[]> {
    return of([
      ...
      },
      {
          ...
          text: 'Which African country is known as the "Land of a Thousand Hills" due to its hilly and mountainous terrain, as well as being home to the mountain gorillas??',
          choices: ['Sahara Desert', 'Gobi Desert', 'Arabian Desert', 'Mojave Desert'],
          correctAnswerIndex: 0
